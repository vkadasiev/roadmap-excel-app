...
- Broken print fallback experiment (`data-print-text`, print-only `::after`, wider print card widths, and `--print-scale`) was rolled back because it made cards fall apart in PDF. Current print fix is limited to explicit text colors in print CSS.
