...
- Print layout now computes `--print-scale` and scales the full `.roadmap-surface` to fit within `PRINT_SAFE_WIDTH`/`PRINT_SAFE_HEIGHT`, preventing page cropping after print card widths were increased.
